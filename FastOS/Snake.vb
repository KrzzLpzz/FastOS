...
Public Class Snake
    ...
    Private snakeBrush As Brush = New SolidBrush(Color.FromArgb(3, 0, 207))
    Private backBrush As Brush = New SolidBrush(Color.FromArgb(1, 1, 1))
    Private tokenBrush As Brush = New SolidBrush(Color.FromArgb(255, 106, 0))
    ...
    Private Sub moveSnake()
        ...
        If isSnakePart(x, y) = True Then
            ...
            If MessageBox.Show("Ouch! ¿Reiniciar?", "Snake", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                initialize()
                Exit Sub
            Else
                End
